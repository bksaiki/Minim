...
MinimObject *minim_builtin_modulo(MinimEnv *env, size_t argc, MinimObject **args)
{
    if (!minim_integerp(args[0]))
        THROW(minim_argument_error("integer", "modulo", 0, args[0]));

    if (!minim_integerp(args[1]))
        THROW(minim_argument_error("integer", "modulo", 1, args[1]));
...
{
    if (!minim_integerp(args[0]))
        THROW(minim_argument_error("integer", "remainder", 0, args[0]));

    if (!minim_integerp(args[1]))
        THROW(minim_argument_error("integer", "remainder", 1, args[1]));
...
{
    if (!minim_integerp(args[0]))
        THROW(minim_argument_error("integer", "quotient", 0, args[0]));

    if (!minim_integerp(args[1]))
        THROW(minim_argument_error("integer", "quotient", 1, args[1]));
...
MinimObject *minim_builtin_numerator(MinimEnv *env, size_t argc, MinimObject **args)
{
    ...
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "numerator", 0, args[0]));
...
MinimObject *minim_builtin_denominator(MinimEnv *env, size_t argc, MinimObject **args)
{
    ...
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "denominator", 0, args[0]));
...
{
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "floor", 0, args[0]));
...
{
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "ceil", 0, args[0]));
...
{
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "trunc", 0, args[0]));
...
{
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "round", 0, args[0]));
...
{
    if (!minim_integerp(args[0]))
        THROW(minim_argument_error("integer", "gcd", 0, args[0]));

    if (!minim_integerp(args[1]))
        THROW(minim_argument_error("integer", "gcd", 1, args[1]));
...
{
    if (!minim_integerp(args[0]))
        THROW(minim_argument_error("integer", "lcm", 0, args[0]));

    if (!minim_integerp(args[1]))
        THROW(minim_argument_error("integer", "lcm", 1, args[1]));
...
{
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "sqrt", 0, args[0]));
...
{
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "exp", 0, args[0]));
...
{
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "log", 0, args[0]));
...
{
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "sin", 0, args[0]));
...
{
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "cos", 0, args[0]));
...
{
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "tan", 0, args[0]));
...
{
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "asin", 0, args[0]));
...
{
    if (!MINIM_OBJ_NUMBERP(args[0]))
        THROW(minim_argument_error("number", "acos", 0, args[0]));
